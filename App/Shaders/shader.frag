...
void main (void) {
     ...
     * have to specify your own output variable for each framebuffer where the layout (location = 0) modifier specifies 
     * the index of the framebuffer. The color is written to this outColor variable that is linked to the framebuffer 
     * at index specified above.
     *
