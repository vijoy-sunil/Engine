            ...
            */
            ...
            void beginRenderPass (uint32_t deviceInfoId,
                ...
                */
                 ...
                 * for each swap chain image and we need to bind the frame buffer for the swap chain image we want to draw
                 * to. Using the image index parameter which was passed in, we can pick the right frame buffer for the
